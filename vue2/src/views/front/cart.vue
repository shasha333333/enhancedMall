      ...
      <div v-if="carts.length" class="cart">
        <div class="list">
          ...
          <ul class="body">
            <li v-for="cart in carts" class="item" :key="cart.id">
              <div class="check">
                <el-checkbox v-model="cart.checked" :checked="cart.checked ? true : false"
                  @change="changeChecked(cart.id, cart.checked)">&nbsp;</el-checkbox>
              </div>
              <div class="img">
              ...
              <div class="num">
                <el-input-number @change="changeQuantity(cart)" v-model="cart.quantity" :min="1"></el-input-number>
              </div>
              <div class="total">
        ...
        <div class="footer">
          ...
          <span class="total-price">
            ...
            <em>{{ totalPrice }}</em>
            元
            <el-button type="primary" font-size="18px" height="48px" width="200px"
              @click="$router.push({ path: '/buy' })">去结算</el-button>
          </span>
        </div>
      </div>
      <div v-else class="empty">
        <h2>您的购物车还是空的！</h2>
        <el-button type="primary" width="170px" height="48px"
          @click="$router.push({ path: '/productList' })">马上去购物</el-button>
      </div>
    </div>
  </div>
</template>
